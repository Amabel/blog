...
|-|-|-|-|
|[saadeghi/daisyui](https://github.com/saadeghi/daisyui){:target="_blank"}|`ui`,`component`|2024/10/28|基于 Tailwind 的 UI 组件库|
|[atomiks/tippyjs](https://github.com/atomiks/tippyjs){:target="_blank"}|`ui`,`tooltip`,`dropdown`|2024/05/27|提示标签|
|[floating-ui/floating-ui](https://github.com/floating-ui/floating-ui){:target="_blank"}|`ui`,`anchor`|2024/10/28|实现各种组件的定位、漂浮效果|
...
|[slidevjs/slidev](https://github.com/slidevjs/slidev){:target="_blank"}|`ui`,`slide`|2024/10/28|幻灯片效果|
...
|[mrdoob/three.js](https://github.com/mrdoob/three.js){:target="_blank"}|`ui`,`animation`,`3d`|2024/10/28|3D 特效引擎|
...
|[markedjs/marked](https://github.com/markedjs/marked){:target="_blank"}|`ui`,`markdown`|2024/10/28|Markdown 转换工具|
|[codex-team/editor.js](https://github.com/codex-team/editor.js){:target="_blank"}|`ui`,`editor`,`text`|2024/10/28|功能强大的编辑器|
...
|[apache/echarts](https://github.com/apache/echarts){:target="_blank"}|`ui`,`data`,`chart`|2024/10/28|图表生成|
|[mozilla/pdf.js](https://github.com/mozilla/pdf.js){:target="_blank"}|`ui`,`pdf reader`|2024/10/28|PDF 阅读器|
...
|[axios/axios](https://github.com/axios/axios){:target="_blank"}|`http`,`request`,`network`|2024/10/28|HTTP 请求|
...
|[openlayers/openlayers](https://github.com/openlayers/openlayers){:target="_blank"}|`ui`,`maps`|2024/10/28|生成可互动的地图|
|[Leaflet/Leaflet](https://github.com/Leaflet/Leaflet){:target="_blank"}|`ui`,`maps`|2024/10/28|移动端友好的地图|
|[jakubfiala/atrament.js](https://github.com/jakubfiala/atrament.js){:target="_blank"}|`ui`,`canvas`,`drawing`|2024/09/24|写字板，画图板|
|[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw){:target="_blank"}|`ui`,`canvas`,`drawing`|2024/10/28|写字板，画图板|
...
|[cypress-io/cypress](https://github.com/cypress-io/cypress){:target="_blank"}|`test`,`e2e`|2024/10/28|E2E 测试|
|[mswjs/msw](https://github.com/mswjs/msw){:target="_blank"}|`mock`,`data`|2024/10/28|Mock 数据生成|
|[faker-js/faker](https://github.com/faker-js/faker){:target="_blank"}|`mock`,`data`|2024/10/28|Mock 数据生成|
|[fingerprintjs/fingerprintjs](https://github.com/fingerprintjs/fingerprintjs){:target="_blank"}|`browser`,`fingerprint`|2024/10/28|用户识别，部分免费|
...
|Repository Name|Keywords|Last Updated|Note|
|-|-|-|-|
|[vueuse/vueuse](https://github.com/vueuse/vueuse){:target="_blank"}|`tools`,`utilities`|2024/10/28|Vue 的常用工具集合|
|[antfu/vite-ssg](https://github.com/antfu/vite-ssg){:target="_blank"}|`ssg`,`seo`|2024/10/28|静态页面生成，搜索引擎|
...
|[vuetifyjs/vuetify](https://github.com/vuetifyjs/vuetify){:target="_blank"}|`ui`,`component`|2024/10/28|基于 Material Design 的 UI 组件库|
...
|[element-plus/element-plus](https://github.com/element-plus/element-plus){:target="_blank"}|`ui`,`component`|2024/10/28|基于 Element 的 UI 组件库|
|[youzan/vant](https://github.com/youzan/vant){:target="_blank"}|`ui`,`component`|2024/10/28|基于 Vant 的 UI 组件库|
|[varletjs/varlet](https://github.com/varletjs/varlet){:target="_blank"}|`ui`,`component`,`mobile`|2024/10/28|基于 Material Design 的移动端 UI 组件库|
...
|[angular/components](https://github.com/angular/components){:target="_blank"}|`ui`,`component`|2024/10/28|基于 Material Design 的 UI 组件库|
|[ngrx/platform](https://github.com/ngrx/platform){:target="_blank"}|`state`,`store`,`data`|2024/10/28|状态管理，数据共享，存储|
