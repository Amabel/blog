...
|-|-|-|-|
|[saadeghi/daisyui](https://github.com/saadeghi/daisyui){:target="_blank"}|`ui`,`component`|2025/01/30|基于 Tailwind 的 UI 组件库|
...
|[nolimits4web/swiper](https://github.com/nolimits4web/swiper){:target="_blank"}|`ui`,`slide`|2025/01/27|幻灯片效果|
...
|[hakimel/reveal.js](https://github.com/hakimel/reveal.js){:target="_blank"}|`ui`,`swipe`,`mobile`|2025/01/29|移动端的页面滑动方案|
...
|[mrdoob/three.js](https://github.com/mrdoob/three.js){:target="_blank"}|`ui`,`animation`,`3d`|2025/01/30|3D 特效引擎|
...
|[mozilla/pdf.js](https://github.com/mozilla/pdf.js){:target="_blank"}|`ui`,`pdf reader`|2025/01/30|PDF 阅读器|
...
|[axios/axios](https://github.com/axios/axios){:target="_blank"}|`http`,`request`,`network`|2025/01/30|HTTP 请求|
...
|[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw){:target="_blank"}|`ui`,`canvas`,`drawing`|2025/01/30|写字板，画图板|
...
|[cypress-io/cypress](https://github.com/cypress-io/cypress){:target="_blank"}|`test`,`e2e`|2025/01/30|E2E 测试|
...
|Repository Name|Keywords|Last Updated|Note|
|-|-|-|-|
|[vueuse/vueuse](https://github.com/vueuse/vueuse){:target="_blank"}|`tools`,`utilities`|2025/01/30|Vue 的常用工具集合|
...
|[vuetifyjs/vuetify](https://github.com/vuetifyjs/vuetify){:target="_blank"}|`ui`,`component`|2025/01/30|基于 Material Design 的 UI 组件库|
...
|[swimlane/ngx-charts](https://github.com/swimlane/ngx-charts){:target="_blank"}|`ui`,`chart`|2025/01/24|图表生成|
...
|[angular/components](https://github.com/angular/components){:target="_blank"}|`ui`,`component`|2025/01/30|基于 Material Design 的 UI 组件库|
|[ngrx/platform](https://github.com/ngrx/platform){:target="_blank"}|`state`,`store`,`data`|2025/01/28|状态管理，数据共享，存储|
