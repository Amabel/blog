...
|-|-|-|-|
|[saadeghi/daisyui](https://github.com/saadeghi/daisyui){:target="_blank"}|`ui`,`component`|2025/01/29|基于 Tailwind 的 UI 组件库|
...
|[slidevjs/slidev](https://github.com/slidevjs/slidev){:target="_blank"}|`ui`,`slide`|2025/01/29|幻灯片效果|
...
|[mrdoob/three.js](https://github.com/mrdoob/three.js){:target="_blank"}|`ui`,`animation`,`3d`|2025/01/29|3D 特效引擎|
...
|[chartjs/Chart.js](https://github.com/chartjs/Chart.js){:target="_blank"}|`ui`,`data`,`chart`|2025/01/29|图表生成|
|[apache/echarts](https://github.com/apache/echarts){:target="_blank"}|`ui`,`data`,`chart`|2025/01/24|图表生成|
|[mozilla/pdf.js](https://github.com/mozilla/pdf.js){:target="_blank"}|`ui`,`pdf reader`|2025/01/29|PDF 阅读器|
...
|[scurker/currency.js](https://github.com/scurker/currency.js){:target="_blank"}|`input`,`number`,`currency`|2025/01/23|货币运算|
...
|[axios/axios](https://github.com/axios/axios){:target="_blank"}|`http`,`request`,`network`|2025/01/28|HTTP 请求|
...
|[openlayers/openlayers](https://github.com/openlayers/openlayers){:target="_blank"}|`ui`,`maps`|2025/01/29|生成可互动的地图|
...
|[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw){:target="_blank"}|`ui`,`canvas`,`drawing`|2025/01/29|写字板，画图板|
...
|[cypress-io/cypress](https://github.com/cypress-io/cypress){:target="_blank"}|`test`,`e2e`|2025/01/29|E2E 测试|
...
|[fingerprintjs/fingerprintjs](https://github.com/fingerprintjs/fingerprintjs){:target="_blank"}|`browser`,`fingerprint`|2025/01/29|用户识别，部分免费|
...
|Repository Name|Keywords|Last Updated|Note|
|-|-|-|-|
|[vueuse/vueuse](https://github.com/vueuse/vueuse){:target="_blank"}|`tools`,`utilities`|2025/01/28|Vue 的常用工具集合|
...
|[vuetifyjs/vuetify](https://github.com/vuetifyjs/vuetify){:target="_blank"}|`ui`,`component`|2025/01/29|基于 Material Design 的 UI 组件库|
...
|[vueComponent/ant-design-vue](https://github.com/vueComponent/ant-design-vue){:target="_blank"}|`ui`,`component`|2025/01/24|基于 Ant Design 的 UI 组件库|
|[element-plus/element-plus](https://github.com/element-plus/element-plus){:target="_blank"}|`ui`,`component`|2025/01/28|基于 Element 的 UI 组件库|
...
|[angular/components](https://github.com/angular/components){:target="_blank"}|`ui`,`component`|2025/01/29|基于 Material Design 的 UI 组件库|
