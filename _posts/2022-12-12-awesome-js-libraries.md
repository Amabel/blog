...
|[mrdoob/three.js](https://github.com/mrdoob/three.js){:target="_blank"}|`ui`,`animation`,`3d`|2025/01/19|3D 特效引擎|
...
|[mozilla/pdf.js](https://github.com/mozilla/pdf.js){:target="_blank"}|`ui`,`pdf reader`|2025/01/19|PDF 阅读器|
...
|[faker-js/faker](https://github.com/faker-js/faker){:target="_blank"}|`mock`,`data`|2025/01/19|Mock 数据生成|
...
|[vuetifyjs/vuetify](https://github.com/vuetifyjs/vuetify){:target="_blank"}|`ui`,`component`|2025/01/19|基于 Material Design 的 UI 组件库|
...
|[element-plus/element-plus](https://github.com/element-plus/element-plus){:target="_blank"}|`ui`,`component`|2025/01/19|基于 Element 的 UI 组件库|
