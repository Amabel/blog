...
|[floating-ui/floating-ui](https://github.com/floating-ui/floating-ui){:target="_blank"}|`ui`,`anchor`|2024/06/13|实现各种组件的定位、漂浮效果|
...
|[slidevjs/slidev](https://github.com/slidevjs/slidev){:target="_blank"}|`ui`,`slide`|2024/06/13|幻灯片效果|
...
|[usablica/intro.js](https://github.com/usablica/intro.js){:target="_blank"}|`ui`,`onboarding`|2024/06/13|界面操作引导|
...
|[mrdoob/three.js](https://github.com/mrdoob/three.js){:target="_blank"}|`ui`,`animation`,`3d`|2024/06/13|3D 特效引擎|
...
|[markedjs/marked](https://github.com/markedjs/marked){:target="_blank"}|`ui`,`markdown`|2024/06/13|Markdown 转换工具|
...
|[apache/echarts](https://github.com/apache/echarts){:target="_blank"}|`ui`,`data`,`chart`|2024/06/13|图表生成|
|[mozilla/pdf.js](https://github.com/mozilla/pdf.js){:target="_blank"}|`ui`,`pdf reader`|2024/06/13|PDF 阅读器|
|[zenorocha/clipboard.js](https://github.com/zenorocha/clipboard.js){:target="_blank"}|`clipboard`|2024/01/09|剪贴板|
|[js-cookie/js-cookie](https://github.com/js-cookie/js-cookie){:target="_blank"}|`cookie`|2024/06/12|Cookie 的使用|
...
|[axios/axios](https://github.com/axios/axios){:target="_blank"}|`http`,`request`,`network`|2024/06/12|HTTP 请求|
...
|[openlayers/openlayers](https://github.com/openlayers/openlayers){:target="_blank"}|`ui`,`maps`|2024/06/13|生成可互动的地图|
...
|[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw){:target="_blank"}|`ui`,`canvas`,`drawing`|2024/06/13|写字板，画图板|
...
|[cypress-io/cypress](https://github.com/cypress-io/cypress){:target="_blank"}|`test`,`e2e`|2024/06/13|E2E 测试|
|[mswjs/msw](https://github.com/mswjs/msw){:target="_blank"}|`mock`,`data`|2024/06/13|Mock 数据生成|
|[faker-js/faker](https://github.com/faker-js/faker){:target="_blank"}|`mock`,`data`|2024/06/13|Mock 数据生成|
...
|Repository Name|Keywords|Last Updated|Note|
|-|-|-|-|
|[vueuse/vueuse](https://github.com/vueuse/vueuse){:target="_blank"}|`tools`,`utilities`|2024/06/13|Vue 的常用工具集合|
...
|[vuetifyjs/vuetify](https://github.com/vuetifyjs/vuetify){:target="_blank"}|`ui`,`component`|2024/06/13|基于 Material Design 的 UI 组件库|
|[DevCloudFE/vue-devui](https://github.com/DevCloudFE/vue-devui){:target="_blank"}|`ui`,`component`|2024/06/13|基于 DevUI Design 的 UI 组件库|
...
|[element-plus/element-plus](https://github.com/element-plus/element-plus){:target="_blank"}|`ui`,`component`|2024/06/13|基于 Element 的 UI 组件库|
|[youzan/vant](https://github.com/youzan/vant){:target="_blank"}|`ui`,`component`|2024/06/11|基于 Vant 的 UI 组件库|
|[varletjs/varlet](https://github.com/varletjs/varlet){:target="_blank"}|`ui`,`component`,`mobile`|2024/06/13|基于 Material Design 的移动端 UI 组件库|
...
|[vuejs/pinia](https://github.com/vuejs/pinia){:target="_blank"}|`state`,`store`,`data`|2024/06/13|状态管理，数据共享，存储|
...
|[angular/components](https://github.com/angular/components){:target="_blank"}|`ui`,`component`|2024/06/13|基于 Material Design 的 UI 组件库|
|[ngrx/platform](https://github.com/ngrx/platform){:target="_blank"}|`state`,`store`,`data`|2024/06/13|状态管理，数据共享，存储|
