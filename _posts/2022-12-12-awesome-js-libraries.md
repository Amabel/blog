...
|-|-|-|-|
|[saadeghi/daisyui](https://github.com/saadeghi/daisyui){:target="_blank"}|`ui`,`component`|2025/01/16|基于 Tailwind 的 UI 组件库|
...
|[mrdoob/three.js](https://github.com/mrdoob/three.js){:target="_blank"}|`ui`,`animation`,`3d`|2025/01/16|3D 特效引擎|
...
|[apache/echarts](https://github.com/apache/echarts){:target="_blank"}|`ui`,`data`,`chart`|2025/01/16|图表生成|
|[mozilla/pdf.js](https://github.com/mozilla/pdf.js){:target="_blank"}|`ui`,`pdf reader`|2025/01/15|PDF 阅读器|
...
|[scurker/currency.js](https://github.com/scurker/currency.js){:target="_blank"}|`input`,`number`,`currency`|2025/01/16|货币运算|
...
|[iamkun/dayjs](https://github.com/iamkun/dayjs){:target="_blank"}|`format`,`date`,`time`|2025/01/15|格式化时间、日期。更轻量|
...
|[openlayers/openlayers](https://github.com/openlayers/openlayers){:target="_blank"}|`ui`,`maps`|2025/01/16|生成可互动的地图|
...
|[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw){:target="_blank"}|`ui`,`canvas`,`drawing`|2025/01/16|写字板，画图板|
...
|[cypress-io/cypress](https://github.com/cypress-io/cypress){:target="_blank"}|`test`,`e2e`|2025/01/16|E2E 测试|
|[mswjs/msw](https://github.com/mswjs/msw){:target="_blank"}|`mock`,`data`|2025/01/10|Mock 数据生成|
|[faker-js/faker](https://github.com/faker-js/faker){:target="_blank"}|`mock`,`data`|2025/01/15|Mock 数据生成|
...
|Repository Name|Keywords|Last Updated|Note|
|-|-|-|-|
|[typestack/class-validator](https://github.com/typestack/class-validator){:target="_blank"}|`class`,`transform`|2025/01/15|基于 decorator 的自动类型验证|
|[typestack/class-transformer](https://github.com/typestack/class-transformer){:target="_blank"}|`class`,`transform`|2025/01/15|基于 decorator 的自动类型转换|

## Vue

|Repository Name|Keywords|Last Updated|Note|
|-|-|-|-|
|[vueuse/vueuse](https://github.com/vueuse/vueuse){:target="_blank"}|`tools`,`utilities`|2025/01/16|Vue 的常用工具集合|
...
|[vuetifyjs/vuetify](https://github.com/vuetifyjs/vuetify){:target="_blank"}|`ui`,`component`|2025/01/16|基于 Material Design 的 UI 组件库|
...
|[vueComponent/ant-design-vue](https://github.com/vueComponent/ant-design-vue){:target="_blank"}|`ui`,`component`|2025/01/15|基于 Ant Design 的 UI 组件库|
|[element-plus/element-plus](https://github.com/element-plus/element-plus){:target="_blank"}|`ui`,`component`|2025/01/16|基于 Element 的 UI 组件库|
...
|[vuejs/pinia](https://github.com/vuejs/pinia){:target="_blank"}|`state`,`store`,`data`|2025/01/15|状态管理，数据共享，存储|
...
|[NG-ZORRO/ng-zorro-antd](https://github.com/NG-ZORRO/ng-zorro-antd){:target="_blank"}|`ui`,`component`|2025/01/16|基于 Ant Design 的 UI 组件库|
|[angular/components](https://github.com/angular/components){:target="_blank"}|`ui`,`component`|2025/01/16|基于 Material Design 的 UI 组件库|
|[ngrx/platform](https://github.com/ngrx/platform){:target="_blank"}|`state`,`store`,`data`|2025/01/16|状态管理，数据共享，存储|
