...
|-|-|-|-|
|[saadeghi/daisyui](https://github.com/saadeghi/daisyui){:target="_blank"}|`ui`,`component`|2024/12/05|基于 Tailwind 的 UI 组件库|
|[atomiks/tippyjs](https://github.com/atomiks/tippyjs){:target="_blank"}|`ui`,`tooltip`,`dropdown`|2024/05/27|提示标签|
|[floating-ui/floating-ui](https://github.com/floating-ui/floating-ui){:target="_blank"}|`ui`,`anchor`|2024/12/05|实现各种组件的定位、漂浮效果|
...
|[slidevjs/slidev](https://github.com/slidevjs/slidev){:target="_blank"}|`ui`,`slide`|2024/12/04|幻灯片效果|
|[sindresorhus/screenfull](https://github.com/sindresorhus/screenfull){:target="_blank"}|`ui`,`full screen`|2022/07/08|全屏显示|
|[alvarotrigo/fullPage.js](https://github.com/alvarotrigo/fullPage.js){:target="_blank"}|`ui`,`swipe`,`page`|2024/12/02|整页效果|
...
|[mrdoob/three.js](https://github.com/mrdoob/three.js){:target="_blank"}|`ui`,`animation`,`3d`|2024/12/05|3D 特效引擎|
...
|[apache/echarts](https://github.com/apache/echarts){:target="_blank"}|`ui`,`data`,`chart`|2024/12/05|图表生成|
|[mozilla/pdf.js](https://github.com/mozilla/pdf.js){:target="_blank"}|`ui`,`pdf reader`|2024/12/05|PDF 阅读器|
...
|[scurker/currency.js](https://github.com/scurker/currency.js){:target="_blank"}|`input`,`number`,`currency`|2024/12/03|货币运算|
...
|[faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js){:target="_blank"}|`user agent`,`browser`,`environment`|2024/12/03|用户 UA 检测|
|[axios/axios](https://github.com/axios/axios){:target="_blank"}|`http`,`request`,`network`|2024/12/05|HTTP 请求|
...
|[openlayers/openlayers](https://github.com/openlayers/openlayers){:target="_blank"}|`ui`,`maps`|2024/12/05|生成可互动的地图|
|[Leaflet/Leaflet](https://github.com/Leaflet/Leaflet){:target="_blank"}|`ui`,`maps`|2024/12/02|移动端友好的地图|
|[jakubfiala/atrament.js](https://github.com/jakubfiala/atrament.js){:target="_blank"}|`ui`,`canvas`,`drawing`|2024/11/21|写字板，画图板|
|[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw){:target="_blank"}|`ui`,`canvas`,`drawing`|2024/12/05|写字板，画图板|
...
|[cypress-io/cypress](https://github.com/cypress-io/cypress){:target="_blank"}|`test`,`e2e`|2024/12/05|E2E 测试|
|[mswjs/msw](https://github.com/mswjs/msw){:target="_blank"}|`mock`,`data`|2024/12/05|Mock 数据生成|
|[faker-js/faker](https://github.com/faker-js/faker){:target="_blank"}|`mock`,`data`|2024/12/05|Mock 数据生成|
...
|[vuetifyjs/vuetify](https://github.com/vuetifyjs/vuetify){:target="_blank"}|`ui`,`component`|2024/12/05|基于 Material Design 的 UI 组件库|
...
|[element-plus/element-plus](https://github.com/element-plus/element-plus){:target="_blank"}|`ui`,`component`|2024/12/05|基于 Element 的 UI 组件库|
|[youzan/vant](https://github.com/youzan/vant){:target="_blank"}|`ui`,`component`|2024/12/02|基于 Vant 的 UI 组件库|
|[varletjs/varlet](https://github.com/varletjs/varlet){:target="_blank"}|`ui`,`component`,`mobile`|2024/12/05|基于 Material Design 的移动端 UI 组件库|
...
|[NG-ZORRO/ng-zorro-antd](https://github.com/NG-ZORRO/ng-zorro-antd){:target="_blank"}|`ui`,`component`|2024/12/05|基于 Ant Design 的 UI 组件库|
|[angular/components](https://github.com/angular/components){:target="_blank"}|`ui`,`component`|2024/12/05|基于 Material Design 的 UI 组件库|
|[ngrx/platform](https://github.com/ngrx/platform){:target="_blank"}|`state`,`store`,`data`|2024/12/04|状态管理，数据共享，存储|
