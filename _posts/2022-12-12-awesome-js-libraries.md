...
|-|-|-|-|
|[saadeghi/daisyui](https://github.com/saadeghi/daisyui){:target="_blank"}|`ui`,`component`|2024/11/08|基于 Tailwind 的 UI 组件库|
|[atomiks/tippyjs](https://github.com/atomiks/tippyjs){:target="_blank"}|`ui`,`tooltip`,`dropdown`|2024/05/27|提示标签|
|[floating-ui/floating-ui](https://github.com/floating-ui/floating-ui){:target="_blank"}|`ui`,`anchor`|2024/11/09|实现各种组件的定位、漂浮效果|
...
|[slidevjs/slidev](https://github.com/slidevjs/slidev){:target="_blank"}|`ui`,`slide`|2024/11/10|幻灯片效果|
...
|[highlightjs/highlight.js](https://github.com/highlightjs/highlight.js){:target="_blank"}|`ui`,`text`,`markdown`,`code`|2024/11/06|代码高亮|
...
|[mrdoob/three.js](https://github.com/mrdoob/three.js){:target="_blank"}|`ui`,`animation`,`3d`|2024/11/11|3D 特效引擎|
...
|[apache/echarts](https://github.com/apache/echarts){:target="_blank"}|`ui`,`data`,`chart`|2024/11/11|图表生成|
|[mozilla/pdf.js](https://github.com/mozilla/pdf.js){:target="_blank"}|`ui`,`pdf reader`|2024/11/11|PDF 阅读器|
...
|[faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js){:target="_blank"}|`user agent`,`browser`,`environment`|2024/11/11|用户 UA 检测|
|[axios/axios](https://github.com/axios/axios){:target="_blank"}|`http`,`request`,`network`|2024/11/11|HTTP 请求|
|[softonic/axios-retry](https://github.com/softonic/axios-retry){:target="_blank"}|`http`,`request`,`axios`|2024/08/02|axios 的重试插件|
|[i18next/i18next](https://github.com/i18next/i18next){:target="_blank"}|`i18n`,`translate`,`language`|2024/11/08|国际化|
...
|[videojs/video.js](https://github.com/videojs/video.js){:target="_blank"}|`video player`,`media`|2024/10/30|视频播放器|
...
|[openlayers/openlayers](https://github.com/openlayers/openlayers){:target="_blank"}|`ui`,`maps`|2024/11/11|生成可互动的地图|
...
|[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw){:target="_blank"}|`ui`,`canvas`,`drawing`|2024/11/11|写字板，画图板|
...
|[cypress-io/cypress](https://github.com/cypress-io/cypress){:target="_blank"}|`test`,`e2e`|2024/11/09|E2E 测试|
|[mswjs/msw](https://github.com/mswjs/msw){:target="_blank"}|`mock`,`data`|2024/11/10|Mock 数据生成|
|[faker-js/faker](https://github.com/faker-js/faker){:target="_blank"}|`mock`,`data`|2024/11/11|Mock 数据生成|
...
|Repository Name|Keywords|Last Updated|Note|
|-|-|-|-|
|[typestack/class-validator](https://github.com/typestack/class-validator){:target="_blank"}|`class`,`transform`|2024/11/06|基于 decorator 的自动类型验证|
|[typestack/class-transformer](https://github.com/typestack/class-transformer){:target="_blank"}|`class`,`transform`|2024/11/06|基于 decorator 的自动类型转换|
...
|[vuetifyjs/vuetify](https://github.com/vuetifyjs/vuetify){:target="_blank"}|`ui`,`component`|2024/11/10|基于 Material Design 的 UI 组件库|
...
|[element-plus/element-plus](https://github.com/element-plus/element-plus){:target="_blank"}|`ui`,`component`|2024/11/11|基于 Element 的 UI 组件库|
|[youzan/vant](https://github.com/youzan/vant){:target="_blank"}|`ui`,`component`|2024/11/11|基于 Vant 的 UI 组件库|
|[varletjs/varlet](https://github.com/varletjs/varlet){:target="_blank"}|`ui`,`component`,`mobile`|2024/11/08|基于 Material Design 的移动端 UI 组件库|
...
|[vuejs/pinia](https://github.com/vuejs/pinia){:target="_blank"}|`state`,`store`,`data`|2024/11/08|状态管理，数据共享，存储|
...
|[swimlane/ngx-charts](https://github.com/swimlane/ngx-charts){:target="_blank"}|`ui`,`chart`|2024/11/05|图表生成|
|[NG-ZORRO/ng-zorro-antd](https://github.com/NG-ZORRO/ng-zorro-antd){:target="_blank"}|`ui`,`component`|2024/11/11|基于 Ant Design 的 UI 组件库|
|[angular/components](https://github.com/angular/components){:target="_blank"}|`ui`,`component`|2024/11/11|基于 Material Design 的 UI 组件库|
|[ngrx/platform](https://github.com/ngrx/platform){:target="_blank"}|`state`,`store`,`data`|2024/11/11|状态管理，数据共享，存储|
