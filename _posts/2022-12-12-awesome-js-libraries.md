...
|[floating-ui/floating-ui](https://github.com/floating-ui/floating-ui){:target="_blank"}|`ui`,`anchor`|2024/06/24|实现各种组件的定位、漂浮效果|
...
|[slidevjs/slidev](https://github.com/slidevjs/slidev){:target="_blank"}|`ui`,`slide`|2024/06/24|幻灯片效果|
|[sindresorhus/screenfull](https://github.com/sindresorhus/screenfull){:target="_blank"}|`ui`,`full screen`|2022/07/08|全屏显示|
|[alvarotrigo/fullPage.js](https://github.com/alvarotrigo/fullPage.js){:target="_blank"}|`ui`,`swipe`,`page`|2024/06/22|整页效果|
|[hakimel/reveal.js](https://github.com/hakimel/reveal.js){:target="_blank"}|`ui`,`swipe`,`mobile`|2024/06/13|移动端的页面滑动方案|
|[usablica/intro.js](https://github.com/usablica/intro.js){:target="_blank"}|`ui`,`onboarding`|2024/06/23|界面操作引导|
...
|[mrdoob/three.js](https://github.com/mrdoob/three.js){:target="_blank"}|`ui`,`animation`,`3d`|2024/06/24|3D 特效引擎|
...
|[markedjs/marked](https://github.com/markedjs/marked){:target="_blank"}|`ui`,`markdown`|2024/06/24|Markdown 转换工具|
...
|[apache/echarts](https://github.com/apache/echarts){:target="_blank"}|`ui`,`data`,`chart`|2024/06/24|图表生成|
|[mozilla/pdf.js](https://github.com/mozilla/pdf.js){:target="_blank"}|`ui`,`pdf reader`|2024/06/24|PDF 阅读器|
...
|[faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js){:target="_blank"}|`user agent`,`browser`,`environment`|2024/06/22|用户 UA 检测|
...
|[videojs/video.js](https://github.com/videojs/video.js){:target="_blank"}|`video player`,`media`|2024/06/24|视频播放器|
...
|[openlayers/openlayers](https://github.com/openlayers/openlayers){:target="_blank"}|`ui`,`maps`|2024/06/24|生成可互动的地图|
...
|[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw){:target="_blank"}|`ui`,`canvas`,`drawing`|2024/06/24|写字板，画图板|
...
|[cypress-io/cypress](https://github.com/cypress-io/cypress){:target="_blank"}|`test`,`e2e`|2024/06/24|E2E 测试|
...
|Repository Name|Keywords|Last Updated|Note|
|-|-|-|-|
|[vueuse/vueuse](https://github.com/vueuse/vueuse){:target="_blank"}|`tools`,`utilities`|2024/06/24|Vue 的常用工具集合|
...
|[vueComponent/ant-design-vue](https://github.com/vueComponent/ant-design-vue){:target="_blank"}|`ui`,`component`|2024/06/23|基于 Ant Design 的 UI 组件库|
|[element-plus/element-plus](https://github.com/element-plus/element-plus){:target="_blank"}|`ui`,`component`|2024/06/24|基于 Element 的 UI 组件库|
|[youzan/vant](https://github.com/youzan/vant){:target="_blank"}|`ui`,`component`|2024/06/24|基于 Vant 的 UI 组件库|
|[varletjs/varlet](https://github.com/varletjs/varlet){:target="_blank"}|`ui`,`component`,`mobile`|2024/06/24|基于 Material Design 的移动端 UI 组件库|
...
|Repository Name|Keywords|Last Updated|Note|
|-|-|-|-|
|[KroneCorylus/ngx-colors](https://github.com/KroneCorylus/ngx-colors){:target="_blank"}|`ui`,`color`,`picker`|2024/06/23|颜色选择器|
|[swimlane/ngx-charts](https://github.com/swimlane/ngx-charts){:target="_blank"}|`ui`,`chart`|2024/05/31|图表生成|
|[NG-ZORRO/ng-zorro-antd](https://github.com/NG-ZORRO/ng-zorro-antd){:target="_blank"}|`ui`,`component`|2024/06/23|基于 Ant Design 的 UI 组件库|
|[angular/components](https://github.com/angular/components){:target="_blank"}|`ui`,`component`|2024/06/24|基于 Material Design 的 UI 组件库|
