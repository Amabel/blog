...
|[slidevjs/slidev](https://github.com/slidevjs/slidev){:target="_blank"}|`ui`,`slide`|2025/01/30|幻灯片效果|
...
|[mrdoob/three.js](https://github.com/mrdoob/three.js){:target="_blank"}|`ui`,`animation`,`3d`|2025/02/01|3D 特效引擎|
...
|[mozilla/pdf.js](https://github.com/mozilla/pdf.js){:target="_blank"}|`ui`,`pdf reader`|2025/02/01|PDF 阅读器|
...
|[axios/axios](https://github.com/axios/axios){:target="_blank"}|`http`,`request`,`network`|2025/01/31|HTTP 请求|
...
|[openlayers/openlayers](https://github.com/openlayers/openlayers){:target="_blank"}|`ui`,`maps`|2025/02/01|生成可互动的地图|
...
|[cypress-io/cypress](https://github.com/cypress-io/cypress){:target="_blank"}|`test`,`e2e`|2025/02/01|E2E 测试|
...
|[element-plus/element-plus](https://github.com/element-plus/element-plus){:target="_blank"}|`ui`,`component`|2025/02/01|基于 Element 的 UI 组件库|
...
|[vuejs/pinia](https://github.com/vuejs/pinia){:target="_blank"}|`state`,`store`,`data`|2025/01/31|状态管理，数据共享，存储|
...
|[angular/components](https://github.com/angular/components){:target="_blank"}|`ui`,`component`|2025/01/31|基于 Material Design 的 UI 组件库|
