...
|[nolimits4web/swiper](https://github.com/nolimits4web/swiper){:target="_blank"}|`ui`,`slide`|2024/11/01|幻灯片效果|
...
|[hakimel/reveal.js](https://github.com/hakimel/reveal.js){:target="_blank"}|`ui`,`swipe`,`mobile`|2024/11/06|移动端的页面滑动方案|
...
|[mrdoob/three.js](https://github.com/mrdoob/three.js){:target="_blank"}|`ui`,`animation`,`3d`|2024/11/10|3D 特效引擎|
...
|[markedjs/marked](https://github.com/markedjs/marked){:target="_blank"}|`ui`,`markdown`|2024/11/10|Markdown 转换工具|
|[codex-team/editor.js](https://github.com/codex-team/editor.js){:target="_blank"}|`ui`,`editor`,`text`|2024/11/09|功能强大的编辑器|
...
|[apache/echarts](https://github.com/apache/echarts){:target="_blank"}|`ui`,`data`,`chart`|2024/11/09|图表生成|
|[mozilla/pdf.js](https://github.com/mozilla/pdf.js){:target="_blank"}|`ui`,`pdf reader`|2024/11/10|PDF 阅读器|
...
|[faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js){:target="_blank"}|`user agent`,`browser`,`environment`|2024/11/10|用户 UA 检测|
|[axios/axios](https://github.com/axios/axios){:target="_blank"}|`http`,`request`,`network`|2024/11/09|HTTP 请求|
...
|[openlayers/openlayers](https://github.com/openlayers/openlayers){:target="_blank"}|`ui`,`maps`|2024/11/08|生成可互动的地图|
|[Leaflet/Leaflet](https://github.com/Leaflet/Leaflet){:target="_blank"}|`ui`,`maps`|2024/11/04|移动端友好的地图|
|[jakubfiala/atrament.js](https://github.com/jakubfiala/atrament.js){:target="_blank"}|`ui`,`canvas`,`drawing`|2024/09/24|写字板，画图板|
|[excalidraw/excalidraw](https://github.com/excalidraw/excalidraw){:target="_blank"}|`ui`,`canvas`,`drawing`|2024/11/09|写字板，画图板|
...
|[faker-js/faker](https://github.com/faker-js/faker){:target="_blank"}|`mock`,`data`|2024/11/10|Mock 数据生成|
...
|[vueComponent/ant-design-vue](https://github.com/vueComponent/ant-design-vue){:target="_blank"}|`ui`,`component`|2024/11/08|基于 Ant Design 的 UI 组件库|
|[element-plus/element-plus](https://github.com/element-plus/element-plus){:target="_blank"}|`ui`,`component`|2024/11/10|基于 Element 的 UI 组件库|
|[youzan/vant](https://github.com/youzan/vant){:target="_blank"}|`ui`,`component`|2024/11/10|基于 Vant 的 UI 组件库|
...
|[NG-ZORRO/ng-zorro-antd](https://github.com/NG-ZORRO/ng-zorro-antd){:target="_blank"}|`ui`,`component`|2024/11/08|基于 Ant Design 的 UI 组件库|
|[angular/components](https://github.com/angular/components){:target="_blank"}|`ui`,`component`|2024/11/07|基于 Material Design 的 UI 组件库|
|[ngrx/platform](https://github.com/ngrx/platform){:target="_blank"}|`state`,`store`,`data`|2024/11/10|状态管理，数据共享，存储|
